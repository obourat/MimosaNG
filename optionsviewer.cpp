...
void OptionsViewer::onDisplayDescriptiveCardButtonTriggered()
{
    if(selectedOption == "configurations")
    {
        ...
        descriptiveCard = new DescriptiveCard(dataManager, dataViewer, "GCA", keysList[0],"current",this);
        descriptiveCard->show();
    }
    else if(selectedOption == "attributes")
    {
        //On instancie une vue descriptiveCard correspondant à la fiche descriptive pour l'objet sélectionné
        descriptiveCard = new DescriptiveCard(dataManager, dataViewer, "GAT", keysList[0],"current",this);
        descriptiveCard->show();
    }
}
...
void OptionsViewer::onDisplayDescriptiveCardCompleteButtonTriggered()
{
    ...
    {
        //On instancie une vue descriptiveCard correspondant à la fiche descriptive pour l'objet sélectionné
        descriptiveCard = new DescriptiveCard(dataManager, dataViewer, "GCA", keysList[0],"complete",this);
        descriptiveCard->show();
    }
    else if(selectedOption == "attributes")
    {
        //On instancie une vue descriptiveCard correspondant à la fiche descriptive pour l'objet sélectionné
        descriptiveCard = new DescriptiveCard(dataManager, dataViewer,"GAT", keysList[0],"complete",this);
        descriptiveCard->show();
    }
}
