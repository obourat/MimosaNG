...
{
    columnToRemoveCodeObject = codeObject;
    columnToRemoveConfigName = currentConfigName;
    columnToRemoveIndex = index;
    emit this->signalRemoveColumn();
}

void MainWindow::triggerSignalRemoveColumn()
{
    emit this->signalRemoveColumn();
}
...
QString MainWindow::getColumnToRemoveConfigName() const
{
    return columnToRemoveConfigName;
}

void MainWindow::setColumnToRemoveConfigName(const QString &value)
{
    columnToRemoveConfigName = value;
}

QString MainWindow::getColumnToRemoveCodeObject() const
{
    return columnToRemoveCodeObject;
}

void MainWindow::setColumnToRemoveCodeObject(const QString &value)
{
